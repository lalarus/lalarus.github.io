...
##### Process
*Overall research process: moving from exploration to ideation*<br>
...
*Discover: From desk research to intervention*<br>
...
![&#x2BA4; The different materials included in one probe kit](img/2-probekitcontents.jpg){fig-alt="A photo of a redpoll."}


::: {.challenges}
##### Challenges
Probe studies require considerable time and effort.
Instructions must be well thought through and leave no room for interpretation.
:::


*Define: Bringing all the data together*<br>



![&#x2BA4; Affinity notes created from the data gained from the probe studies](img/3-affinitynotes.jpg){fig-alt="A photo of a redpoll."}

![&#x2BA4; A part of the finalized affinity diagram](img/3-affinitydiagram.jpg){fig-alt="A photo of a redpoll."}
...
![&#x2BA4;; Types of design patterns that classify design mechanisms that make people feel least in control over how they spend their time in the Instagram app. The description explains how a design pattern undermines user sense of agency. Design patterns are listed in the order of frequency of corresponding responses from the affinity diagram.](img/4-LCdesignpatterns.jpg){fig-alt="A photo of a redpoll."}

::: {.iterations}
##### Iterations
Analyzing and clustering data on your own is difficult. After asking a second person for feedback, I discarded my first affinity diagram and started from scratch.
:::


*Develop: designing to support user agency*<br>

- 4 How-might-we (HMW) question, acting as design challenges
- 4 prototypes 


![&#x2BA4; Mockups of the original design (left) and the redesign (right) of the Feed and Stories mechanisms.](img/5-prototype-fomo-800.jpg){fig-alt="A photo of a redpoll."}

![&#x2BA4; Mockups of the original design (left) and the redesign (right) of the Reels mechanism.](img/5-prototype-easeofuse-800.jpg){fig-alt="A photo of a redpoll."}


::: {.challenges}
##### Challenges
Ideating on your own is tedious and lacks valuable feedback and inspiration from others. Here, this left me with insufficient time to test my prototypes.
:::
