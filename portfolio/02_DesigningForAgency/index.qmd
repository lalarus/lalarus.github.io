...
![&#x2BA4; The different materials included in one probe kit](img/2-probekitcontents.jpg){fig-alt="Different materials included in one probe kit are spread out on a table, seen from bird's eye view." .round}
...
![&#x2BA4; Affinity notes created from the data gained from the probe studies](img/3-affinitynotes.jpg){fig-alt="" .round}

![&#x2BA4; A part of the finalized affinity diagram](img/3-affinitydiagram.jpg){fig-alt="" .round}
